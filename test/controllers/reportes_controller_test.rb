...
class ReportesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reporte" do
    assert_difference('Reporte.count') do
      post reportes_url, params: { reporte: { descripcion: @reporte.descripcion, fecha: @reporte.fecha, monto: @reporte.monto, referencia: @reporte.referencia, saldo: @reporte.saldo } }
    end
  ...
  test "should update reporte" do
    patch reporte_url(@reporte), params: { reporte: { descripcion: @reporte.descripcion, fecha: @reporte.fecha, monto: @reporte.monto, referencia: @reporte.referencia, saldo: @reporte.saldo } }
